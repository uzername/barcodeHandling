...
class DataBaseHandler {
    ...
    public function reCreateDataStructure() {
        $commandList = [
            ...
            '(ID INTEGER PRIMARY KEY AUTOINCREMENT, PATHTOBARCODE TEXT, RAWBARCODEREGISTERED TEXT NOT NULL UNIQUE, FIELD1 TEXT, FIELD2 TEXT, FIELD3 TEXT, FIELDPOSITION TEXT, FIELDGENDER INTEGER, BARCODETYPE VARCHAR(10) )',
